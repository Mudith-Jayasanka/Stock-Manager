...
const developmentConnectionString =
  'postgresql://neondb_owner:npg_hIguoSkMAc16@ep-spring-salad-aos4um6n-pooler.c-2.ap-southeast-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require';
